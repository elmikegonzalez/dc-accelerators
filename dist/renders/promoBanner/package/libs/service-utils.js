(function () {
    ...
    Utils.prototype = {
        ...
        getHtmlServiceData: function (params) {
            ...
            var url = encodeURI(params.auth.baseUrl + '/v1/content/' +
                ...
                '&locale=' + params.auth.locale +'&v=' + Date.now());
        ...
        getQueryURL: function(params) {
          ...
          var url = 'https://' + paramsObj.vse + '/cms/content/query?fullBodyObject=true&scope=tree&store=any&query=%7B"sys.iri":"http://content.cms.amplience.com/' + paramsObj.content + '"%7D&v=' + Date.now() + '&locale=' + paramsObj.locale + ',en-US';
          // console.debug('url: ' + url);
          return url;
        },
        postProcessing: {
    ...
    window.AmpDC = window.AmpDC || {};
    window.AmpDC.Utils = Utils;
})();
...
{
    module.exports = window.AmpDC.Utils;
}
else if (typeof define === 'function' && define.amd) {
    define([], function () {
        'use strict';
        return window.AmpDC.Utils;
    });
}
